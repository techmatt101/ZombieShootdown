...
/// <reference path="core\Attributes.ts" />
...
/// <reference path="core\gameobjects\attributes\Health.ts" />
/// <reference path="core\gameobjects\attributes\IAttr.ts" />
/// <reference path="core\gameobjects\attributes\InputControl.ts" />
/// <reference path="core\gameobjects\attributes\Movement.ts" />
/// <reference path="core\gameobjects\attributes\WeaponHolder.ts" />
/// <reference path="core\gameobjects\attributes\ZombieAI.ts" />
